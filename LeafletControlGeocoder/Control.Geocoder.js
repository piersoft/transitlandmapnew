...
curPoslat: function(result){
		return this._geocodeMarker.lat;
},
curPoslng: function(result){
	return this._geocodeMarker.lng;
},
		markGeocode: function(result) {
			...
			console.log(result.center.lat);
				...
				this._geocodeMarker.bindPopup(result.html+'</br><a href="locator.php?lat='+result.center.lat+'&lon='+result.center.lng+'&r=9000">Trova fermate attorno</a>' || result.name+'Trova fermate attorno')
				this._geocodeMarker.addTo(this._map)
